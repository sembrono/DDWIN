...
function Start() {
  ...
  SYSMIRROR32='https://oss.suntl.com/Windows/Win7_86_Administrator_nat.ee.gz'
  SYSMIRROR33='https://file.1323123.xyz/dd/windows/cxthhhhh/Disk_Windows_7_Vienna_Ultimate_CN_v2.0.vhd.gz'
  SYSMIRROR34='https://oss.suntl.com/Windows/Win7_sp1_64_Administrator_nat.ee.gz'
  SYSMIRROR35='https://oss.sunpma.com/Windows/Whole/Win7_sp1_64_Administrator_nat.ee.gz'
  SYSMIRROR36='https://oss.sunpma.com/Windows/Whole/Win8.1_64_Administrator_nat.ee.gz'
  SYSMIRROR37='https://oss.sunpma.com/Windows/Whole/Win10_LTSC_64_Administrator_nat.ee.gz'
  SYSMIRROR38='https://oss.suntl.com/Windows/Win10_2016LTSB_64_Administrator_nat.ee.gz'
  SYSMIRROR39='https://oss.suntl.com/Windows/Win10_2019LTSC_64_Administrator_nat.ee.gz'
  SYSMIRROR40='https://oss.suntl.com/Windows/Win10_2021LTSC_64_Administrator_nat.ee.gz'
  SYSMIRROR41='https://file.1323123.xyz/dd/windows/1keydd/win10ltsc_password_1keydd.gz'
  ...
  echo "  32) Windows7 32位 精简版 BIOS [账户Administrator密码nat.ee]"
  echo "  33) Win7旗舰版精简版 BIOS [账户Administrator密码cxthhhhh.com]带播放器"
  echo "  34) Windows7 sp1 64位 企业精简版 BIOS [账户Administrator密码nat.ee]"
  echo "  35) Windows7 sp1 64位 企业完整版 [账户Administrator密码nat.ee]"
  echo "  36) Windows8.1 64位 完整版 [账户Administrator密码nat.ee]"
  echo "  37) Windows10 LTSC 64位 完整版 [账户Administrator密码nat.ee]"
  echo "  38) Windows10 2016LTSB 64位 企业深度精简版 BIOS [账户Administrator密码nat.ee] 没有IE"
  echo "  39) Windows10 2019LTSC 64位 企业深度精简版 BIOS [账户Administrator密码nat.ee]"
  echo "  40) Windows10 2021LTSC 64位 企业深度精简版 BIOS [账户Administrator密码nat.ee]"
  echo "  41) Windows10 LTSC 64位 精简版 BIOS+UEFI [账户Administrator密码1keydd]"
